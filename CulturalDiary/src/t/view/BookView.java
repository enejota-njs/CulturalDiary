...
public class BookView {
    ...
    public void registrationMessages(int a, int b) {
        switch (a) {
            case 1 : {
                System.out.print("\nDigite o título: ");
                break;
    ...
    public void invalidDate(int a, int b) {
        switch (a) {
            case 1 : {
    ...
    public void additionalRegisterOptions() {
        System.out.println("\n[ 1 ] - Abrir Livro");
    ...
    public void invalidHasCopy() {
        System.out.println("\nInválido.");
        System.out.println("Digite Sim ou Não.");
        System.out.println("Tente novamente.");
    }

    public void searchMessages(int a) {
        switch (a) {
            case 1 : {
                System.out.println("\n+-------------------------+");
    ...
    public void additionalSearchOptions() {
    ...
    public void additionalListOptions() {
        System.out.println("\n[ 1 ] - Abrir livro");
        System.out.println("[ 2 ] - Avaliar livro");
    ...
    public void filterOptions(int a) {
        switch (a){
            case 0 : {
                System.out.println("\n+-------------------------+");
                System.out.printf("| %-23s |\n", "Filtrar por");
    ...
    public void evaluationMessages(int a) {
        switch (a) {
            case 0 : {
    ...
    public void reviewMessages(int a) {
        switch (a) {
            case 0 : {
    ...
    public void orderingMessage(int a) {
        switch (a) {
            case 0 : {
    ...
    public void moreInformation(BookModel book) {
        System.out.println("\n+-----------------------+");
